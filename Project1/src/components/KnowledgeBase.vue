    ...
    <div class="main-content">
      ...
      <div class="document-card">
        ...
        <div class="document-list">
          <div v-for="(doc, index) in documents" :key="doc.id" class="document-item">
            <div class="col-name">
              <div class="file-icon" :class="doc.typeClass">
                <span v-if="doc.type === 'pdf'" class="file-emoji">📕</span>
                <span v-else-if="doc.type === 'word'" class="file-emoji">📄</span>
                <span v-else-if="doc.type === 'ppt'" class="file-emoji">📊</span>
                <span v-else-if="doc.type === 'image'" class="file-emoji">🖼️</span>
            ...
            <div class="col-status">
              <span v-if="doc.status === 'processed'" class="status-badge success">
            ...
            <div class="col-actions">
              <button @click="viewDocument(doc)" class="action-btn view" title="预览">
                <span class="action-emoji">👁️</span>
              </button>
              <button @click="deleteDocument(doc.id)" class="action-btn delete" title="删除">
                <span class="action-emoji">🗑️</span>
              </button>
            </div>
          </div>
...
const handleFileUpload = (e) => {
  ...
  files.forEach((file, index) => {
    const typeMap = {
      'application/pdf': { type: 'pdf', typeClass: 'pdf', typeLabel: 'PDF文档' },
      'application/msword': { type: 'word', typeClass: 'word', typeLabel: 'Word文档' },
      'application/vnd.openxmlformats-officedocument.wordprocessingml.document': { type: 'word', typeClass: 'word', typeLabel: 'Word文档' },
      'application/vnd.ms-powerpoint': { type: 'ppt', typeClass: 'ppt', typeLabel: 'PPT演示' },
      'application/vnd.openxmlformats-officedocument.presentationml.presentation': { type: 'ppt', typeClass: 'ppt', typeLabel: 'PPT演示' },
    ...
    const fileType = typeMap[file.type] || { type: 'other', typeClass: 'other', typeLabel: '文件' }
